            ...
            <div class="container-fluid p-0">
                <div class="card" style="background-color:#d8e7f7;">
                    <div class="card-body">
                        ...
                        <div style="text-align:center;"><h4 style="color: #7196be;">Create Course Application Account</h4></div> 
                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-0" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-1 row">
                                    <div class="col-6">
                                    <x-input-label for="login" :value="__('Country *')" />
                                    <select class="form-select"  name="country" id="validationCustom03" required value="{{ old('country') }}" autofocus>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                    ...
                                    <div class="col-6">
                                    <x-input-label for="login" :value="__('Phone *')" />
                                        <input id="phone" type="tel" class="form-control" type="text" name="phone" required value="{{old('phone')}}">
                                ...
                                <div class="form-group mb-1 row">
                                    ...
                                    <x-input-label for="password" :value="__('Email *')" />
                                        <input id="password" class="form-control" type="email" name="email" value="{{old('email')}}" required>
                                ...
                                <div class="form-group mb-3 text-center row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" style="background-color:#7196be;" type="submit">Create</button>
                                    </div>
                                </div>

                                <div class="form-group mb-3 text-center row mt-3 pt-1">
                                    <div class="col-12" style="width: 900px;">
                                    <a href="{{route('userLogin')}}" class="text-muted"><i class="mdi mdi-account-circle"></i> already have account: Login</a>
                                    </div>
                                </div>
