...
<div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <form action="{{ route('class.students.confirm.registration') }}" method="POST">
                                    @csrf
                                    ...
                                    @endforeach
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-secondary">Confirm student(s)</button> &nbsp;&nbsp;
                                        <a href="{{route('students.confirm.registration', ['id'=>Auth::user()->id])}}">
