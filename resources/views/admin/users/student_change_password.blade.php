...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>MCHS Portal | Reset Student Password</title>
...
@endif
<form action="{{route('admin.update.student.password', $student->id)}}" method="POST" class="custom-validation">
    @csrf
    <h5>Reset password for: {{$student->fname}} {{$student->lname}} | {{$student->reg_num}}</h5><p></p><hr>
