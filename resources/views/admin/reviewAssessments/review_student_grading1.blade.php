                    ...
                    <div class="container-fluid">
                        ...
                        @if($assessment == 1) 
                            <!--END OF SEMESTER SEND TO HOD -->
                                    ...
                                    @if((Auth::user()->role=='HOD' || Auth::user()->role=='HOD-BASIC' || Auth::user()->role=='Lecturer' || Auth::user()->role=='Principal') && $subjfromlecturerTable->userid == Auth::user()->id)
                                        <ul class="breadcrumb m-0">
