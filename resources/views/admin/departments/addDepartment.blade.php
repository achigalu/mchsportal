...
<h4 class="mb-sm-0">{{$faculty->faculty_name}}</h4>
...
<p class="card-title-desc">A department is attached to a faculty.</p>
    ...
    <div class="row">
        ...
        <div class="row mb-3">
            <label class="form-label">Department Name</label>
                    ...
                    <div class="col-sm-12">
                    <input class="form-control" name="faculty_id" value="{{$faculty->id}}" type="text"  hidden>
                    @error('department_name') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" name="department_name" type="text" placeholder="Department Name" id="example-text-input">
                    </div>
            </div>
            ...
            <div class="mb-3">
                ...
                @error('department_head_id') <span class="text-danger">{{$message}}</span> @enderror
                <select class="form-control select2" name="department_head_id">
                    <option value="">-- Select --</option>
