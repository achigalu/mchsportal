                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0" style="color: gray;">Departments under: {{$record->faculty_name}}</h4>
...
<div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="#">PDF</a>
                    ...
                    <a href="{{route('view.faculty')}}"><li class="btn btn-secondary">
                        <i class=" fas fa-arrow-left"></i>&nbsp;&nbsp;Back</li></a>&nbsp;

                    <a href="{{route('add.department',$record->id)}}">
                    <li class="btn btn-secondary"><i class="fas fa-plus">
                    </i>&nbsp;&nbsp;Add Department</li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </a>
                    </ul>
                                    </div>
        ...
        @php $i = 1; @endphp
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="{{route('edit.department',$department->id)}}"><button class="btn btn-outline-info"><i class="fas fa-pencil-alt"></i></button></a>
