        ...
        <div id="layout-wrapper">
           ...
           @include('admin.layout.top_bar')
            ...
            <div class="page-content">
                    <div class="container-fluid">
                        ...
                        @if($assessment == 1 || $assessment == 2 || $assessment == 3) 
                            ...
                            <!-- SUBMIT TO HOD-->
                                        ...
                                        @if(Auth::user()->id == $subj->userid && ($access_level1 == Auth::user()->id || $access_level2 == Auth::user()->id || $access_level3 == Auth::user()->id) && Auth::user()->role != 'HOD')
                                                <ul class="breadcrumb m-0">         
                            ...
                            @if(($assessment == 1 || $assessment == 2 || $assessment == 3) && Auth::user()->role == 'HOD') 
                                    @if(Auth::user()->id == $subj->userid)
                                    @else
                                                <ul class="breadcrumb m-0">
                                                
                                                <li class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#backToLecturer{{$id}}{{$assessment}}{{$ay}}">
                 ...
                 @endif
                            <!---
                            @if(($assessment == 1 || $assessment == 2 || $assessment == 3) && Auth::user()->role == 'Dean') 
                                        <ul class="breadcrumb m-0">
                                        
                                        <li class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#hod{{$id}}{{$assessment}}{{$ay}}"><i class="mdi mdi-publish" ></i>&nbsp; Submit back to Lecturer</li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            -->
                             ...
                             <!-- SUBMIT TO REGISTRAR
                                        ...
                                        <li class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#hod{{$id}}{{$assessment}}{{$ay}}"><i class="mdi mdi-publish" ></i>&nbsp; Submit to Registrar</li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        
                                        </ul>
                             SUBMIT TO ED
                                         <ul class="breadcrumb m-0">
                                        
                                        <li class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#hod{{$id}}{{$assessment}}{{$ay}}"><i class="mdi mdi-publish" ></i>&nbsp; Submit to ED</li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    value="{{ $student->assessment1 ?? '' }}" 
                                                     
                                                    {{ $lectSub->userid == $lectSub->access_level1 ? '' : 'readonly' }}>
                                                    ...
                                                    {{ $lectSub->userid == $lectSub->access_level2 ? '' : 'readonly' }}>
                                                    @endif
                                                    ...
                                                    {{ $lectSub->userid == $lectSub->access_level3 ? '' : 'readonly' }}>
                                                    @endif
                                                    ...
                                                    {{ $lectSub->userid == $lectSub->access_level4 ? '' : 'readonly' }}>
                                                    @endif
                                                ...
                                                @foreach($assessments as $key => $accessField)
                                                    ...
                                                    @else
                                                        @if($assessment == $key && $student->$accessField == 0)
                                                            ...
                                                            {!! '<strong>' . ($gradesWith->role == 'Registrar' ? 'REGISTRAR' : ' ') . '</strong>' !!}
                                                            {!! '<strong>' . ($gradesWith->role == 'ED' ? 'ED' : ' ') . '</strong>' !!}
