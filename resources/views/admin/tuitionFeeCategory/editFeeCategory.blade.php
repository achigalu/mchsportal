...
@endif
<form action="{{route('update.category' , $feecategory->id)}}" method="post">
    @csrf
    <div class="row">
        <div class="col-lg-12">
        ...
        <div class="row mb-3">
            <label class="form-label">Name</label>
                    ...
                    @error('feename') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" type="text" name="feename" value="{{$feecategory->feename}}" id="example-text-input">
                    </div>
            </div>
            ...
            <label class="form-label">Code</label>
                    ...
                    @error('feecode') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" type="text" name="feecode" value="{{$feecategory->feecode}}" id="example-text-input">
                    </div>
            </div>
            ...
            <label class="form-label">Local fee(MK)</label>
                    ...
                    @error('localfee') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" type="number" name="localfee" value="{{$feecategory->local_fee}}" id="example-text-input">
                    </div>
            </div>
            ...
            <label class="form-label">Foreign fee($)</label>
                    ...
                    @error('foreignfee') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" type="number" name="foreignfee" value="{{$feecategory->foreign_fee}}" id="example-text-input">
                    </div>
            </div>
