                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Tuition Fee Structure List</h4>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="{{route('add.fee.structures')}}">
                                        <li class="btn btn-secondary"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add Tuition Fee Structure</li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </a>
                                        </ul>
                                    </div>
