...
<h4 class="card-title">Cumulative Semesters for a Class</h4>
...
<br>
                    ...
                    <form action="{{route('signing.off.semester.increments')}}" method="post">
                     @csrf
                    <div class="row">
                    ...
                    <div class="card-body" >
                    <select class="form-control select2" name="ay" aria-label="Default select example" Required>
                    <option value=""> -- select --</option>
                        @foreach($ay as $acy)
...
-->
                    ...
                    <div class="card-body">
                    <button class="btn btn-warning" type="submit" style="margin-top: 8px;">Increment Semesters for registration</button>
                    </div>
                    </div>
                    </div>
                    </form>
