...
<html lang="en">
    ...
    <meta charset="utf-8" />
        <title>MCHS Portal | Add subjects to old students</title>
...
<h4 class="card-title"><b>Assign subjects to old students</b></h4><br>
...
@endif
<form action="{{route('add.subject.to.old.studentss')}}" method="post" enctype="" >
    @csrf
                    <div class="row">
                    @php 
                    ...
                    <div class="card-body">
                    <button class="btn btn-info w-100" type="submit" style="margin-top: 8px;">View subjects</button>
                    </div>
                    </div>
                    </div>
                    </div>
