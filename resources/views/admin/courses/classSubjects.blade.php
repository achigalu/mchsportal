                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    @if(session()->has('message'))
                                       ...
                                       <h4>
                                       Assign Subjects to: {{$class->classcode}} | {{$class->classname}} - @if($class->campus_id ==1) Lilongwe Campus @endif
                                       @if($class->campus_id ==2) Blantyre Campus @endif @if($class->campus_id ==3) Zomba Campus @endif
                                       </h4> 
