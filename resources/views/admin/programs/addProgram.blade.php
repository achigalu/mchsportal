...
<h4 class="mb-sm-0">Add Program</h4>
...
<h4 class="card-title">Add Program Details</h4>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-12">
                    @error('program_code') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" name="program_code" type="text" placeholder="enter short name like : CCM" id="example-text-input">
                    </div>
        </div>
        ...
        <div class="row mb-3">
            <label class="form-label">Program Name</label>
                    ...
                    @error('program_name') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" name="program_name" type="text" placeholder="ie Diploma in Optometry" id="example-text-input">
                    </div>
        </div>
        ...
        <div class="row mb-3">
            <label class="form-label">Duration (in Months)</label>
                    ...
                    @error('duration') <span class="text-danger">{{$message}}</span> @enderror
                        <input class="form-control" name="duration" type="number"  id="example-text-input">
                    </div>
        </div>

        <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Entry Level</label>
                    <div class="col-sm-12">
