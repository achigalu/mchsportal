                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5>Selection List Uploads : {{$studentsingle->programclass}} - {{$studentsingle->campus}}</h5><br>
...
@endif
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach($allclassupload as $student)
                                            ...
                                            <tr>
                                                ...
                                                <button type="button" class="btn btn-warning waves-effect waves-light "><i class="fas fa-trash"></i></button>
